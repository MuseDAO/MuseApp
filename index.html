            ...
            <div class="header header-06">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <a href="#" class="logo"> <img src="assets/img/logo1.jpg" alt=""></a>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-12">
                                <!-- heading start  -->
                                <div class="heading">
                                    <h1 class="text-white wow fadeInUp" data-wow-delay=".2s">We are your <br> MUSE</h1>
                                </div>
                                <!-- heading end  -->
                            </div>
                            <div class="col-xl-5 col-lg-5">
                                <!-- desc strat  -->
                                <p class="wow fadeInLeft" data-wow-delay=".4s">Join the community of your favorite content creators and get exclusive access to their content.</p>
                                <!-- desc end  -->
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                ...
                                <div class="section-title">
                                    <h1 class="wow fadeInUp" data-wow-delay=".2s">Top Content Creators</h1>
                                    <h2 class="wow fadeInUp" data-wow-delay=".4s">Be apart of this exclusive<br class="d-none d-lg-block"> community.</h2>
                                </div>
                                <!-- section-title end  -->
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="copyright wow fadeInLeft" data-wow-delay=".2s">
                                <p>Part of <a href="htts://uideck.com" rel="nofollow">MuseDAO</a></p>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="credit wow fadeInRight" data-wow-delay=".4s">
                                <p>This is our webpage.<a rel="nofollow" href="https://soonlaunch.com">MuseDAO</a></p>
                            </div>
                        </div>
                    </div>
                </div>
